  ...
  return (
    ...
    >
      <nav className={`flex flex-col space-y-6 flex-grow`}>
        <button onClick={() => setCurrentPage('newExperiment')} className={linkClass('newExperiment')} style={linkStyle('newExperiment')} title="New Experiment">
        ...
        <button onClick={() => setCurrentPage('history')} className={linkClass('history')} style={linkStyle('history')} title="History">
        ...
        <button onClick={() => setCurrentPage('explore')} className={linkClass('explore')} style={linkStyle('explore')} title="Explore">
        ...
        <button onClick={() => setCurrentPage('conversations')} className={linkClass('conversations')} style={linkStyle('conversations')} title="Conversations">
      ...
      <div className={`mt-auto flex flex-col space-y-6`}>
        ...
        <button onClick={() => setCurrentPage('about')} className={linkClass('about')} style={linkStyle('about')} title="About LLaMa-Herd">
